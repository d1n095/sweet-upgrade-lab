...
const TrackOrder = () => {
  ...
  const content = {
    ...
    de: {
      ...
      pageTitle: 'Seuraa tilaustasi',
      pageBadge: 'Tilauksen seuranta',
      pageDescription: 'Syötä tilausnumerosi ja sähköpostiosoitteesi nähdäksesi toimituksen tilan.',
      orderNumber: 'Tilausnumero',
      orderNumberPlaceholder: 'Esim. #1001',
      email: 'Sähköpostiosoite',
      emailPlaceholder: 'sinun@email.fi',
      searchButton: 'Hae tilaus',
      searching: 'Haetaan...',
      notFoundTitle: 'Tilausta ei löydy',
      notFoundDescription: 'Emme löytäneet tilausta näillä tiedoilla. Tarkista tilausnumero ja sähköposti.',
      notFoundHelp: 'Tarvitsetko apua? Ota yhteyttä asiakaspalveluumme.',
      contactUs: 'Ota yhteyttä',
      deliveryInfoTitle: 'Toimitusajat',
      deliveryInfoText: `Tuotteemme lähetetään EU-toimittajilta ja toimitetaan yleensä ${storeConfig.shipping.deliveryDays} arkipäivän kuluessa.`,
    ...
    nl: {
      pageTitle: 'Volg uw bestelling',
      pageBadge: 'Bestelling volgen',
      pageDescription: 'Voer uw bestelnummer en e-mailadres in om de leveringsstatus te bekijken.',
      orderNumber: 'Bestelnummer',
      orderNumberPlaceholder: 'Bijv. #1001',
      email: 'E-mailadres',
      emailPlaceholder: 'uw@email.nl',
      searchButton: 'Bestelling zoeken',
      searching: 'Zoeken...',
      notFoundTitle: 'Geen bestelling gevonden',
      notFoundDescription: 'We konden geen bestelling vinden met deze gegevens. Controleer uw bestelnummer en e-mail.',
      notFoundHelp: 'Heeft u hulp nodig? Neem contact op met onze klantenservice.',
      contactUs: 'Neem contact op',
      deliveryInfoTitle: 'Levertijden',
      deliveryInfoText: `Onze producten worden verzonden door EU-leveranciers en worden normaal gesproken binnen ${storeConfig.shipping.deliveryDays} werkdagen geleverd.`,
    ...
    fr: {
      pageTitle: 'Suivre votre commande',
      pageBadge: 'Suivi de commande',
      pageDescription: 'Entrez votre numéro de commande et votre e-mail pour voir le statut de livraison.',
      orderNumber: 'Numéro de commande',
      orderNumberPlaceholder: 'Ex. #1001',
      email: 'Adresse e-mail',
      emailPlaceholder: 'votre@email.fr',
      searchButton: 'Rechercher la commande',
      searching: 'Recherche...',
      notFoundTitle: 'Aucune commande trouvée',
      notFoundDescription: 'Nous n\'avons pas trouvé de commande avec ces informations. Vérifiez votre numéro de commande et votre e-mail.',
      notFoundHelp: 'Besoin d\'aide ? Contactez notre service client.',
      contactUs: 'Nous contacter',
      deliveryInfoTitle: 'Délais de livraison',
      deliveryInfoText: `Nos produits sont expédiés par des fournisseurs de l'UE et sont généralement livrés dans ${storeConfig.shipping.deliveryDays} jours ouvrables.`,
    ...
    es: {
      pageTitle: 'Seguir su pedido',
      pageBadge: 'Seguimiento de pedido',
      pageDescription: 'Ingrese su número de pedido y correo electrónico para ver el estado de entrega.',
      orderNumber: 'Número de pedido',
      orderNumberPlaceholder: 'Ej. #1001',
      email: 'Correo electrónico',
      emailPlaceholder: 'su@email.es',
      searchButton: 'Buscar pedido',
      searching: 'Buscando...',
      notFoundTitle: 'Pedido no encontrado',
      notFoundDescription: 'No pudimos encontrar un pedido con estos datos. Verifique su número de pedido y correo electrónico.',
      notFoundHelp: '¿Necesita ayuda? Contacte nuestro servicio al cliente.',
      contactUs: 'Contáctenos',
      deliveryInfoTitle: 'Plazos de entrega',
      deliveryInfoText: `Nuestros productos son enviados por proveedores de la UE y normalmente se entregan en ${storeConfig.shipping.deliveryDays} días hábiles.`,
    ...
    pl: {
      ...
      pageBadge: 'Śledzenie zamówienia',
      pageDescription: 'Wprowadź numer zamówienia i adres e-mail, aby sprawdzić status dostawy.',
      orderNumber: 'Numer zamówienia',
      orderNumberPlaceholder: 'Np. #1001',
      email: 'Adres e-mail',
      emailPlaceholder: 'twoj@email.pl',
      searchButton: 'Szukaj zamówienia',
      searching: 'Szukanie...',
      notFoundTitle: 'Nie znaleziono zamówienia',
      notFoundDescription: 'Nie mogliśmy znaleźć zamówienia z tymi danymi. Sprawdź numer zamówienia i e-mail.',
      notFoundHelp: 'Potrzebujesz pomocy? Skontaktuj się z naszą obsługą klienta.',
      contactUs: 'Skontaktuj się z nami',
      deliveryInfoTitle: 'Terminy dostawy',
      deliveryInfoText: `Nasze produkty są wysyłane przez dostawców z UE i zazwyczaj dostarczane w ciągu ${storeConfig.shipping.deliveryDays} dni roboczych.`,
