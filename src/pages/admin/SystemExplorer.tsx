...
import { LogsViewer, ScanViewer, ValidationView } from "@/pages/admin/system";
  ...
  return (
    <div className="flex h-full min-h-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {mainTab === "backendscan" && (
          <ScanViewer
            latestBackendScan={latestBackendScan}
            backendScanLoading={backendScanLoading}
            showBackendRaw={showBackendRaw}
            setShowBackendRaw={setShowBackendRaw}
          />
        )}
        ...
        {mainTab === "patch" && (
          <ValidationView
            ...
            setPatchStatus={setPatchStatus}
            safeModeEnabled={safeModeEnabled}
            setSafeModeEnabled={setSafeModeEnabled}
            patchSubmitted={patchSubmitted}
            setPatchSubmitted={setPatchSubmitted}
