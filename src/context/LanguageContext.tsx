...
export type Language = 'sv' | 'en' | 'no' | 'da' | 'de';
...
export const translations: Translations = {
  ...
  'hero.badge': { sv: 'Svensk Startup 2026', en: 'Swedish Startup 2026', no: 'Svensk Startup 2026', da: 'Svensk Startup 2026', de: 'Schwedisches Startup 2026' },
  'hero.title': { sv: 'Giftfria Produkter för Sverige', en: 'Toxin-Free Products for Sweden', no: 'Giftfrie Produkter for Norden', da: 'Giftfrie Produkter til Norden', de: 'Schadstofffreie Produkte' },
