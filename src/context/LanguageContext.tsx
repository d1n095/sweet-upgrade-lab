...
export const translations: Translations = {
  ...
  'hero.title': { sv: 'Noggrant utvalt. Giftfritt.', en: 'Carefully curated. Toxin-free.', no: 'Nøye utvalgt. Giftfritt.', da: 'Omhyggeligt udvalgt. Giftfrit.', de: 'Sorgfältig ausgewählt. Schadstofffrei.', fi: 'Huolella valikoitu. Myrkytön.', nl: 'Zorgvuldig geselecteerd. Gifvrij.', fr: 'Soigneusement sélectionné. Sans toxines.', es: 'Cuidadosamente seleccionado. Sin toxinas.', pl: 'Starannie wyselekcjonowane. Bez toksyn.' },
  'hero.subtitle': { sv: 'Varje produkt analyserad efter ingredienser, certifieringar och recensioner.', en: 'Every product analysed by ingredients, certifications and reviews.', no: 'Hvert produkt analysert etter ingredienser, sertifiseringer og anmeldelser.', da: 'Hvert produkt analyseret efter ingredienser, certificeringer og anmeldelser.', de: 'Jedes Produkt analysiert nach Inhaltsstoffen, Zertifizierungen und Bewertungen.', fi: 'Jokainen tuote analysoitu ainesosien, sertifikaattien ja arvostelujen perusteella.', nl: 'Elk product geanalyseerd op ingrediënten, certificeringen en beoordelingen.', fr: 'Chaque produit analysé selon ses ingrédients, certifications et avis.', es: 'Cada producto analizado por ingredientes, certificaciones y reseñas.', pl: 'Każdy produkt przeanalizowany pod kątem składników, certyfikatów i recenzji.' },
  'hero.cta.primary': { sv: 'Se produkter', en: 'View products', no: 'Se produkter', da: 'Se produkter', de: 'Produkte ansehen', fi: 'Näytä tuotteet', nl: 'Bekijk producten', fr: 'Voir les produits', es: 'Ver productos', pl: 'Zobacz produkty' },
