...
const ProductSuggestions = () => {
  ...
  const content = {
    sv: {
      ...
      descriptionLabel: 'Beskriv produkten',
      descriptionPlaceholder: 'Viktigt: Pris, kvalitet och certifieringar är vårt fokus. Beskriv vad som är viktigt för dig...',
    ...
    en: {
      ...
      descriptionPlaceholder: 'Important: Price, quality and certifications are our focus. Describe what matters to you...',
