...
export const DEFAULT_PRODUCT_FORM_DATA: ProductFormData = {
  ...
  usageStep1: '', usageStep2: '', usageStep3: '',
        ...
        <div className="mb-4 p-3 rounded-lg bg-secondary/30 border border-border/50">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-foreground/70 line-clamp-2">
              {formData.metaDescription || (language === 'sv' ? 'Beskrivning genereras automatiskt...' : 'Description will be auto-generated...')}
            </p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-lg bg-primary/5 border border-primary/10 mb-3">
          <p className="text-xs text-muted-foreground">
            {language === 'sv'
              ...
              : 'SEO is auto-generated if the fields are left empty.'}
          </p>
        </div>
